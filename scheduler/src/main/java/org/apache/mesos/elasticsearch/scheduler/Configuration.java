...
public class Configuration {
    ...
    public List<String> esArguments(ClusterState clusterState, Protos.DiscoveryInfo discoveryInfo, Protos.SlaveID slaveID) {
        ...
        if (taskList.size() > 0) {
            ...
            args.add("-Edefault.discovery.zen.ping.unicast.hosts=" + hostAddress);
        }
        ...
        args.add("-Edefault.network.publish_host=0.0.0.0");
        ...
        //args.add("-Edefault.discovery.zen.minimum_master_nodes=" + getElasticsearchNodes());
